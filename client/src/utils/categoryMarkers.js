 ...
 * Each category gets a unique shape via the marker's SVG background.
 * Works with Google Maps AdvancedMarkerElement (returns DOM elements).
 */
const CATEGORY_CONFIG = {
  ...
  Food: {
    color: "#d35400",
    shape: "rounded-square",
    icon: `<path d="M17 8h1a4 4 0 1 1 0 8h-1" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"/><path d="M3 8h14v9a4 4 0 0 1-4 4H7a4 4 0 0 1-4-4Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"/><line x1="6" y1="2" x2="6" y2="4" stroke="white" stroke-width="2" stroke-linecap="round"/><line x1="10" y1="2" x2="10" y2="4" stroke="white" stroke-width="2" stroke-linecap="round"/><line x1="14" y1="2" x2="14" y2="4" stroke="white" stroke-width="2" stroke-linecap="round"/>`,
  },
  Arts: {
    color: "#e91e63",
    shape: "flower",
...
/**
 * Build the marker HTML string for a category.
 * Used to create DOM elements for AdvancedMarkerElement.
 */
const buildMarkerHTML = (category) => {
...
/**
 * Create a DOM element for a Google Maps AdvancedMarkerElement.
 * Returns a fresh DOM node each time (markers need unique elements).
 */
export const createCategoryMarkerElement = (category) => {
  const wrapper = document.createElement("div");
  wrapper.className = "category-marker-wrapper";
  wrapper.innerHTML = buildMarkerHTML(category);
  return wrapper;
};

/**
 * Get the CATEGORY_CONFIG for external use (e.g. legends).
 */
export const getCategoryConfig = () => CATEGORY_CONFIG;

export default createCategoryMarkerElement;
